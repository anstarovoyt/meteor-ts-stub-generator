...
public class GeneratorTest {
  ...
  public void testSimpleSplit() {
    ...
    LinkedHashMap<String, String> map = generator.splitByBlocks("Template.api.isClient = {\n" +
                                                                "  id: \"meteor_isclient\",\n" +
  ...
  public void testSplitComplexBlock() {
    Generator generator = new Generator();
    LinkedHashMap<String, String> map = generator.splitByBlocks("Template.api.ejsonStringify = {\n" +
                                                                "  id: \"ejson_stringify\",\n" +
