...
interface IApp {
     ...
     *
     *
     * @param {String} domainRule - <p>The pattern defining affected domains or URLs.</p>
     * @param {Options} [options]
     */
    accessRule(domainRule:string,
               options?:{
    ...
    /**
     * Set the build-time configuration for a Phonegap plugin.
     *
     *
     * @param {String} pluginName - <p>The identifier of the plugin you want to
     * configure.</p>
     * @param {Object} config - <p>A set of key-value pairs which will be passed
     * at build-time to configure the specified plugin.</p>
     */
    configurePlugin(pluginName:string, config:any):any;
     ...
     *
     *
     * @param {String} name - <p>A preference name supported by Phonegap's
...
declare module Blaze {
    ...
    interface TemplateInstance {
         ...
         * on server.</p>
         * @param {function or Object} [callbacks] - <p>Optional. May include <code>onStop</code> and
...
declare module Meteor {
     ...
     */
    function Error(error:string, reason?:string, details?:string):Error;
     ...
     * @param {String} name - <p>Name of the subscription.  Matches the name of the
     * server's <code>publish()</code> call.</p>
     * @param {Any} [arg1, arg2...] - <p>Optional arguments passed to publisher
...
interface PackageAPIMember {
     ...
     * @param {String} [architecture] - <p>If you only want to export the file
     ...
     * @param {String} [architecture] - <p>If you only want to export the object
     * on the server (or the client), you can pass in the second argument
     * (e.g., 'server', 'client', 'web.browser', 'web.cordova') to specify
     ...
     * @locus package.js
     *
     * @param {String or Array.<String>} meteorRelease - <p>Specification of a release: track@version. Just 'version' (e.g. <code>&quot;0.9.0&quot;</code>) is sufficient if using the default release track <code>METEOR</code>.</p>
     */
