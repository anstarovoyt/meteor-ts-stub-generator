...
interface PackageAPIMember {
     ...
     * @locus package.js
     *
     * @param {String or Array.<String>} filename - <p>Name of the source file, or array of
     * strings of source file names.</p>
     * @param {String or Array.<String>} [architecture] - <p>If you only want to export the file
     ...
     * @param {Object} [fileOptions] - <p>Options that will be passed to build
     ...
     */
    addFiles(filename:any, architecture?:any, fileOptions?:any):any;
